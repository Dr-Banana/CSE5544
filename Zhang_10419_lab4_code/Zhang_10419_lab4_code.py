...
color_p = sns.color_palette("Blues", reverse=True, as_cmap=True)
ax = sns.countplot(data=year_university_df, y='country', order=year_university_df.country.value_counts().index, palette = color_p)
